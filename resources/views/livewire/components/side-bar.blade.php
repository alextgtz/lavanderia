    ...
    <aside class="@if(isRTL() == true) sidenav mi-container navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-4 rotate-caret @else  sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 ps ps--active-y @endif" id="sidenav-main" data-color="secondary">
        <div class="sidenav-header">
            ...
            <span class="ms-3 h2 font-weight-bold text-uppercase">{{getApplicationName()}}</span>
           
            </a>
        </div>
        <!-- <hr class="horizontal mt-0"> -->
        <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main" style="max-height: 100vh; overflow-y: auto; overflow-x: hidden;">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/dashboard*') ? 'active' : '' }}" href="{{route('admin.dashboard')}}">
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="ni ni-world text-dark text-lg opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">{{$lang->data['vista_general'] ?? 'Vista General'}}</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/pos') ? 'active' : '' }}" href="{{ route('admin.pos') }}">
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="ni ni-fat-add text-dark text-lg opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">{{$lang->data['add_order'] ?? 'Añadir Pedido'}}</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link  {{ Request::is('admin/order-status*') ? 'active' : '' }}" href="{{route('admin.status_screen_order')}}">
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="ni ni-delivery-fast text-dark text-lg opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">{{$lang->data['status_order'] ?? 'Estado del Pedido'}}</span>
                    </a>
                </li>
                <li class="nav-item">
...
<li class="nav-item">
                    <a data-bs-toggle="collapse" href="#expense" class="nav-link {{ Request::is('admin/expense*') ? 'active' : '' }}" aria-controls="settings" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="ni ni-money-coins text-dark text-lg opacity-10"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#settings" class="nav-link {{ Request::is('admin/settings*') ? 'active' : '' }}" aria-controls="settings" role="button" aria-expanded="false">
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="ni ni-settings-gear-65 text-dark text-lg opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">{{$lang->data['ajustes'] ?? 'Ajustes'}}</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" wire:click.prevent="logout" href="#">
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="ni ni-button-power text-dark text-lg opacity-10"></i>
                        </div>
