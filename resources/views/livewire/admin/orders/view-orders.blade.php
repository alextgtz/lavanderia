<div>
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-black">{{ $lang->data['orders'] ?? 'Orders' }}</h5>
        </div>
        <div class="col-auto">
            <a href="{{ route('admin.create_orders') }}" class="btn btn-icon btn-3 btn-secondary text-white mb-0">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0">
                            <thead class="bg-light">
                                <tr>
                                    <th class="text-uppercase text-secondary text-m opacity-7">
                                        {{ $lang->data['order_info'] ?? 'Order Info' }}</th>
                                    <th class="text-uppercase text-secondary text-m  opacity-7">
                                        {{ $lang->data['customer'] ?? 'Customer' }}</th>
                                    <th class="text-uppercase text-secondary text-m  opacity-7">
                                        {{ $lang->data['order_amount'] ?? 'Order Amount' }}</th>
                                    <th class="text-center text-uppercase text-secondary text-m opacity-7">
                                        {{ $lang->data['status'] ?? 'Status' }}</th>
                                    <th class="text-uppercase text-secondary text-m opacity-7">
                                        {{ $lang->data['payment'] ?? 'Payment' }}</th>
                                        <th class="text-uppercase text-secondary text-m opacity-7 ps-2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            ...
                                            @elseif($item->status == 2)
                                                <a type="button"
                                                    class="badge badge-sm bg-primary text-uppercase">{{ $lang->data['ready_to_deliver'] ?? 'Ready To Deliver' }}</a>
                                            @elseif($item->status == 3)
                                                <a type="button"
                                                    class="badge badge-sm bg-success text-uppercase">{{ $lang->data['delivered'] ?? 'Delivered' }}</a>
