<div>
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-black">{{ $lang->data['add_order'] ?? 'Add Order' }}</h5>
        </div>
        <div class="col-auto">
            ...
            <div class="card mb-4">
                <div class="card-header p-4">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <button type="button" class="btn btn-secondary text-white mb-0" data-bs-toggle="modal"
                                data-bs-target="#addcustomer">
                                <i class="fa fa-plus me-2"></i> {{ $lang->data['agregar_cliente'] ?? 'Agregar Cliente' }}
                            </button>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="row align-items-center px-4 mb-3">
                    ...
                    <div class="col-auto">
                        ...
                        <button type="submit" class="btn btn-primary mb-0" data-bs-toggle="modal"
                            data-bs-target="#payment">{{ $lang->data['continuar'] ?? 'Continuar' }}</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary"
                            wire:click.prevent="createCustomer()">{{ $lang->data['guardar'] ?? 'Guardar' }}</button>
                    </div>
                </form>
            </div>
        </div>
                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-6 mx-2 mb-1 " >
                                        ...
                                        <select class="form-select" wire:model="payment_type">
                                            ...
                                            <option class="select-box" value="2">{{ $lang->data['transf'] ?? 'Transf' }}
                                            </option>
