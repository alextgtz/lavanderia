                    ...
                    <div class="invoice-details" style="border-top:none;">
                        <div class="invoice-list">
                            <div class="invoice-title">
                                <h4 class="heading">{{$lang->data['order_invoice']??'Factura de Pedido'}}</h4>
                                <h4 class="heading heading-child"></h4>
                            </div>
                            <div class="row-data" style="border:none; margin-bottom: 1px">
                                <div class="item-info">
                                    <h5 class="item-title"><b>{{$lang->data['order_no']??'Número de Orden'}}</b></h5>
                                </div>
                            ...
                            <div class="row-data" style="border:none; margin-bottom: 1px">
                                <div class="item-info">
                                    <h5 class="item-title"><b>{{$lang->data['order_no']??'Estado'}}</b></h5>
                                </div>
                            ...
                            <!-- <div class="row-data" style="border:none;">
                                <div class="item-info">
                                    <h5 class="item-title"><b>{{$lang->data['created_by']??'Creted By'}}</b></h5>
                                </div>
                            </div> -->
                            
                            <div class="invoice-title" style="text-align: right">
                                <h6 class="heading1">{{ $lang->data['services'] ?? 'Services' }}</h6>
                                <h6 class="heading1 heading-child">{{ $lang->data['importe'] ?? 'Importe' }}</h6>
                        ...
                        <h3 style="text-align: center;"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pagos: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Tipo:</p></h3>
                        @foreach ($payments as $item)
                                        <div class="row-data"
                                            style="text-align: center;margin-top: 5px; padding-bottom: 8px;">
                                            <h5 class="my-5" style="   text-align: left; width: 10px;">
                                                <!-- <b>{{ "Anticipo" }}</b></h5> -->
                                            <!-- <h5 class="my-5 "><b></b></h5>
                                            <h5 class="my-5"><b></b></h5> -->
                                            <h5 class="my-5" style=text-align: center;><b>{{ getCurrency() }}
                                            {{ number_format($item->received_amount, 2) }}</b></h5>
                        ...
                        <div class="invoice-footer mb-15">
                            <div class="row-data">
                                <div class="item-info">
                                    <h5 class="item-title">{{ $lang->data['customer'] ?? 'Customer' }}:</h5>
                                </div>
                            ...
                            <div class="row-data">
                                <div class="item-info">
                                    <h5 class="item-title">{{ $lang->data['complementos'] ?? 'Complementos' }}:</h5>
                                </div>
                                <h5 class="my-5">
                            ...
                            <div class="row-data">
                                <div class="item-info">
                                    <h5 class="item-title">{{ $lang->data['total'] ?? 'Total' }}:
                                    </h5>
                                </div>
                        ...
                        <div class="invoice_address">
                            <div class="text-center">
                                ...
                                <p class="b_top">{{$lang->data['desarrollado_por']??'Desarrollado por   '}} <b>{{ getApplicationName() }}</b></p>
                            </div>
                        </div>
                    </div>
                </div>
