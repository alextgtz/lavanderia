<div>
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-black">{{$lang->data['financial_year'] ?? 'Financial Year'}}</h5>
        </div>
        <div class="col-auto">
            ...
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" wire:click.prevent="create" class="btn btn-primary">{{$lang->data['guardar'] ?? 'Guardar'}}</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{$lang->data['cancel'] ?? 'Cancel'}}</button>
                        <button type="submit" wire:click.prevent="update" class="btn btn-primary">{{$lang->data['guardar'] ?? 'Guardar'}}</button>
                    </div>
                </form>
            </div>
        </div>
