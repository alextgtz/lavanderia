<div>
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-black">{{ $lang->data['expense'] ?? 'Expense' }}</h5>
        </div>
        <div class="col-auto">
                ...
                <form>
                        ...
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select class="form-select" wire:model="payment_mode">
                                    ...
                                    <option class="select-box" value="1">{{ $lang->data['efectivo'] ?? 'Efectivo' }}
                                    </option>
                                    <option class="select-box" value="2">{{ $lang->data['transf'] ?? 'Transf' }}</option>
                                    <option class="select-box" value="3">{{ $lang->data['tarjeta'] ?? 'Tarjeta' }}
                                    </option>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" wire:click.prevent="store()"
                            class="btn btn-primary">{{ $lang->data['guardar'] ?? 'Guardar' }}</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <form>
                        ...
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-12 mb-2">
                                ...
                                <select class="form-select" wire:model="payment_mode">
                                    ...
                                    <option class="select-box" value="2">{{ $lang->data['transfer'] ?? 'Transf' }}
                                    </option>
                                    <option class="select-box" value="3">{{ $lang->data['tarjeta'] ?? 'Tarjeta' }}
                                    </option>
                                    <!-- <option class="select-box" value="4">{{ $lang->data['cheque'] ?? 'Cheque' }}
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" wire:click.prevent="update()" class="btn btn-primary">Guardar</button>
                    </div>
                </form>
            </div>
        </div>
