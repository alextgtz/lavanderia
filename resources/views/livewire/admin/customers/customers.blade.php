<div>
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-black">{{ $lang->data['customers'] ?? 'Customers' }}</h5>
        </div>
        <div class="col-auto">
            <a data-bs-toggle="modal" data-bs-target="#addcustomer" wire:click="resetInputFields"
                class="btn btn-icon btn-3 btn-secondary text-white mb-0">
                                ...
                                @foreach ($customers as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- <a wire:click="delete({{ $row->id }})" type="button"
                                                class="badge badge-xs badge-warning fw-600 text-xs">
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary"
                            wire:click.prevent="store()">{{ $lang->data['guardar'] ?? 'Guardar' }}</button>
                    </div>
                </form>
            </div>
        </div>
                ...
                <form>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                            data-bs-dismiss="modal">{{ $lang->data['cancel'] ?? 'Cancel' }}</button>
                        <button type="submit" class="btn btn-primary"
                            wire:click.prevent="update()">{{ $lang->data['guardar'] ?? 'Guardar' }}</button>
                    </div>
                </form>
            </div>
        </div>
