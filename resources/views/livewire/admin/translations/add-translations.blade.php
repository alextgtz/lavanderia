<div>
    <div class="row align-items-center justify-content-between mb-4">
        <div class="col">
            <h5 class="fw-500 text-black">{{$lang->data['create_translations'] ?? 'Create Translations'}}</h5>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
                ...
                <div class="card-body p-3">
                    <form class="row g-3 align-items-center">
                        ...
                        <div class="d-flex align-items-center justify-content-end">
                            <div>
                                <button type="button" class="btn btn-primary ms-4" wire:click.prevent="save">{{$lang->data['guardar']??'Guardar'}}</button>
                            </div>
                        </div>
                    </form>
                </div>
