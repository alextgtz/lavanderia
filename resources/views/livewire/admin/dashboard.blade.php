                        ...
                        <div class="row align-items-center px-2">
                            <div class="col-8">
                                <div class="numbers py-2">
                                    <p class="text-m mb-3 text-uppercase">{{$lang->data['pending_order'] ?? 'Pending Orders'}}</p>
                ...
                <div class="card mb-4">
                    <div class="card-body p-3">
                        <div class="row align-items-center px-2">
                            <div class="col-8">
                                <div class="numbers py-2">
                                    <p class="text-m mb-3 text-uppercase">{{$lang->data['processing_order'] ?? 'Processing Order'}}</p>
                                    <h5 class="font-weight-bolder">
                                        {{$processing_count}}
                                    </h5>
                                </div>
                ...
                <div class="card mb-4">
                    <div class="card-body p-3">
                        <div class="row align-items-center px-2">
                            <div class="col-8">
                                <div class="numbers py-2">
                                    <p class="text-m mb-3 text-uppercase">{{$lang->data['ready_to_deliver'] ?? 'Ready To Deliver'}}</p>
                                    <h5 class="font-weight-bolder">
                                        {{$ready_count}}
                                    </h5>
                                </div>
                ...
                <div class="card mb-4">
                    <div class="card-body p-3">
                        <div class="row align-items-center px-2">
                            <div class="col-8">
                                <div class="numbers py-2">
                                    <p class="text-m mb-3 text-uppercase">{{$lang->data['delivered_orders'] ?? 'Delivered Orders'}}</p>
                                    <h5 class="font-weight-bolder">
                                        {{$delivered_count}}
                                    </h5>
                                </div>
                        ...
                        <div class="{{getOrderStatusWithColor($item->status)}}">
                            <td class="align-middle text-center">
                                ...
                                <div class="d-flex justify-content-center">
                                    <a type="button"
                                    class="badge badge-lg bg-secondary text-uppercase">
                                    {{ $lang->data['pending'] ?? 'Pending' }}</a>
                                </div>
                                @elseif($item->status == 1)
                                <div class="d-flex justify-content-center">
                                    <a type="button"
                                        class="badge badge-lg bg-warning text-uppercase">{{ $lang->data['processing'] ?? 'Processing' }}</a>
                                </div>
                                @elseif($item->status == 2)
                                <div class="d-flex justify-content-center">
                                    <a type="button"
                                        class="badge badge-lg bg-primary text-uppercase">{{ $lang->data['ready_to_deliver'] ?? 'Ready To Deliver' }}</a>
                                </div>
                                @elseif($item->status == 3)
                                <div class="d-flex justify-content-center">
                                    <a type="button"
                                        class="badge badge-lg bg-success text-uppercase">{{ $lang->data['delivered'] ?? 'Delivered' }}</a>
                                </div>
                                @elseif($item->status == 4)
                                <div class="d-flex justify-content-center">
                                    <a type="button"
                                        class="badge badge-lg bg-danger text-uppercase">{{ $lang->data['returned'] ?? 'Returned' }}</a>
                                </div>
                                @endif
                            </td>
    ...
    new Chart(ctx3, {
        ...
        data: {
            datasets: [{
                ...
                pointRadius: 2,
                borderWidth: 2,
                backgroundColor: ['#8392ab', '#faae42', '#0083ff', '#2dce89', '#f5365c'],
