...
function getExpenseCategoryType($type)
{
    ...
    if($lang)
    {
        switch($type)
        {
            ...
            case 3:
                return  $lang->data['operative'] ?? 'Operativos';
            default:
                return '';
        }
    }
...
function getFinancialYearId() {
    ...
    if(isset($site['default_financial_year']) && !empty($site['default_financial_year'])) {
        return (int) $site['default_financial_year']; // Convertir a entero por seguridad
    }

    return null; // Enviar NULL en lugar de ''
}
/* get Currency */
...
function getOrderStatus($status,$preventlang=null)
{
    ...
    if($lang == null || $preventlang)
    {
        ...
        switch($status)
        {
            ...
            case 3:
                return $lang->data['entregado'] ?? 'Entregado';
            case 4:
...
//Cambiar color estado de pedido
function getStatusClass($status)
{
    switch ($status) {
        case 1: // Processing
            return 'btn-warning';
        case 2: // Ready to Deliver
            return 'btn-primary';
        case 3: // Delivered
            return 'btn-success';
        case 4: // Returned
